...
struct pcb_t {
	...
	int arrival_time; 	// The timestamp at which process arrives and wishes to start

	int burst_time;		// The amount of time that process requires to complete its job
